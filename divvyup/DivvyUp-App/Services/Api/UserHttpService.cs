...
namespace DivvyUp_App.Services.Api
{
    public class UserHttpService : IUserService
    {
        ...
        public async Task<string> Login(LoginUserDto request)
        {
            try
            {
                var url = ApiRoute.USER_ROUTES.LOGIN;
        ...
        public async Task Remove()
        {
            try
            {
                var url = ApiRoute.USER_ROUTES.REMOVE;
        ...
        public async Task<bool> ValidToken(string token)
        {
            try
            {
                var url = ApiRoute.USER_ROUTES.VALIDATE_TOKEN
                    .Replace(ApiRoute.ARG_TOKEN, token);
        ...
        public async Task<UserDto> GetUser()
        {
            try
            {
                var url = ApiRoute.USER_ROUTES.ME;
                var response = await _dHttpClient.GetAsync(url);
