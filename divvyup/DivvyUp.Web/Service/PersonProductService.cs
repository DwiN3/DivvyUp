...
namespace DivvyUp.Web.Service
{
    public class PersonProductService : IPersonProductService
    {
        ...
        public PersonProductService(MyDbContext dbContext, IMapper mapper, MyValidator validator, EntityUpdateService entityUpdateService, UserContext userContext)
        {
        ...
        public async Task Add(AddEditPersonProductRequest request, int productId)
        {
        ...
        public async Task Edit(AddEditPersonProductRequest request, int personProductId)
        {
            _validator.IsNull(request, "Nie przekazano danych");
            _validator.IsNull(request.PersonId, "Brak identyfikatora osoby");
            _validator.IsNull(request.Quantity, "Ilość jest wymagana");
